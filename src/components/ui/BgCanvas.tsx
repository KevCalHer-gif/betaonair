...
export default function BgCanvas() {
  ...
  useEffect(() => {
    ...
    // ── Drops ────────────────────────────────────────────────────
    const drops: InkDrop[] = Array.from({ length: 22 }, () => new InkDrop(true))
    ...
    const render = () => {
      ...
      bg.addColorStop(0.67, '#0d1015')
      bg.addColorStop(0.72, '#1a2030')
      ...
      // Surface line
      const surfaceGrad = ctx.createLinearGradient(0, H * 0.62, 0, H * 0.7)
